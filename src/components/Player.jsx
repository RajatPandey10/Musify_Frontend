...
import {Shuffle,SkipBack,Pause,Play,Repeat,SkipForward,ListMusic,Maximize2,Mic,Speaker,Minimize2,Volume2} from 'lucide-react';

const Player = ()=>{

    const {track,seekBar,seekBg,playStatus,
        play,pause,time,previous,next,seekSong} = useContext(PlayerContext);
    ...
    return track? (
        <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
            <div className='hidden lg:flex items-center gap-4'>
                <img src={track.image} alt='' className='w-12'></img>
                <div>
                    <p >{track.name}</p>
