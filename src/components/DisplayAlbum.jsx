    ...
    return albumsData ? (
        <>
            <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
                <img src={album?.imageUrl} alt='' className='w-48 rounded'></img>
                <div className='flex flex-col'>
                    ...
                    <h4>{album?.desc}</h4>
                    <p className='mt-1'>
                        <img src={assets.logo} alt='logo' className='inline-block w-5 mr-1'></img>
                ...
                .map((item,index)=>(
                    ...
                    >
                        <p className='text-white'>
                            ...
                            <img src={item.image} alt='' className='inline w-10 mr-5'></img>
                            {item.name}
                        </p>
